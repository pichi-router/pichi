if(TRANSPARENT_PF AND APPLE)
  ...
  execute_process(COMMAND xcrun --show-sdk-version OUTPUT_VARIABLE macos_ver)
  if(macos_ver VERSION_GREATER_EQUAL 26.4)
    set(xnu_ver "12377.101.15")
  elseif(macos_ver VERSION_GREATER_EQUAL 26.3)
    set(xnu_ver "12377.81.4")
  elseif(macos_ver VERSION_GREATER_EQUAL 26.2)
    set(xnu_ver "12377.61.12")
  elseif(macos_ver VERSION_GREATER_EQUAL 26.1)
    set(xnu_ver "12377.41.6")
  elseif(macos_ver VERSION_GREATER_EQUAL 26.0)
    set(xnu_ver "12377.1.9")
  elseif(macos_ver VERSION_GREATER_EQUAL 15.6)
    set(xnu_ver "11417.140.69")
  elseif(macos_ver VERSION_GREATER_EQUAL 15.5)
    set(xnu_ver "11417.121.6")
  elseif(macos_ver VERSION_GREATER_EQUAL 15.4)
    set(xnu_ver "11417.101.15")
  elseif(macos_ver VERSION_GREATER_EQUAL 15.3)
    set(xnu_ver "11215.81.4")
  elseif(macos_ver VERSION_GREATER_EQUAL 15.2)
    set(xnu_ver "11215.61.5")
  elseif(macos_ver VERSION_GREATER_EQUAL 15.1)
