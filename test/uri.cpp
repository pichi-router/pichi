...
{
  BOOST_CHECK_EXCEPTION(Uri{"http:///"}, SystemError, verify_exception<PichiError::BAD_PROTO>);
  BOOST_CHECK_EXCEPTION(Uri{"http://:80/"}, SystemError, verify_exception<PichiError::BAD_PROTO>);
  BOOST_CHECK_EXCEPTION(Uri{"http://[]/"}, SystemError, verify_exception<PichiError::BAD_PROTO>);
  BOOST_CHECK_EXCEPTION(Uri{"http://[]:80/"}, SystemError, verify_exception<PichiError::BAD_PROTO>);
}
...
BOOST_AUTO_TEST_CASE(Uri_Empty_Path_Without_Query)
{
  ...
  BOOST_CHECK_EXCEPTION(
      Uri{"http://localhost#fragment"},
      SystemError,
      verify_exception<PichiError::BAD_PROTO>
  );
  BOOST_CHECK_EXCEPTION(
      Uri{"http://localhost?query#fragment"},
      SystemError,
      verify_exception<PichiError::BAD_PROTO>
  );
  BOOST_CHECK_EXCEPTION(
      Uri{"http://localhost#fragment?query"},
      SystemError,
      verify_exception<PichiError::BAD_PROTO>
  );
}
...
{
  BOOST_CHECK_EXCEPTION(HostAndPort{""}, SystemError, verify_exception<PichiError::BAD_PROTO>);
  BOOST_CHECK_EXCEPTION(HostAndPort{"[]"}, SystemError, verify_exception<PichiError::BAD_PROTO>);
  BOOST_CHECK_EXCEPTION(HostAndPort{":80"}, SystemError, verify_exception<PichiError::BAD_PROTO>);
  BOOST_CHECK_EXCEPTION(HostAndPort{"[]:80"}, SystemError, verify_exception<PichiError::BAD_PROTO>);
}
