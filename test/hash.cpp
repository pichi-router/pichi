...
template <HashAlgorithm algorithm> void verify(string_view hex, ConstBuffer raw = {})
{
...
{
  verify<HashAlgorithm::MD5>("d41d8cd98f00b204e9800998ecf8427e", ""sv);
  verify<HashAlgorithm::MD5>("0cc175b9c0f1b6a831c399e269772661", "a"sv);
  verify<HashAlgorithm::MD5>("900150983cd24fb0d6963f7d28e17f72", "abc"sv);
  verify<HashAlgorithm::MD5>("f96b697d7cb7938d525a2f31aaf161d0", "message digest"sv);
  verify<HashAlgorithm::MD5>("c3fcd3d76192e4007dfb496cca67e13b", "abcdefghijklmnopqrstuvwxyz"sv);
...
{
  verify<HashAlgorithm::SHA1>("da39a3ee5e6b4b0d3255bfef95601890afd80709", ""sv);
  verify<HashAlgorithm::SHA1>("a9993e364706816aba3e25717850c26c9cd0d89d", "abc"sv);
  ...
  verify<HashAlgorithm::SHA1>("a49b2446a02c645bf419f995b67091253a04a259",
                              ...
                              "mnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu"sv);
...
{
  verify<HashAlgorithm::SHA224>("d14a028c2a3a2bc9476102bb288234c415a2b01f828ea62ac5b3e42f", ""sv);
  verify<HashAlgorithm::SHA224>("23097d223405d8228642a477bda255b32aadbce4bda0b3f7e36c9da7",
                                "abc"sv);
  ...
  verify<HashAlgorithm::SHA224>("c97ca9a559850ce97a04a96def6d99a9e0e0e2ab14e6b8df265fc0b3",
                                ...
                                "klmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu"sv);
